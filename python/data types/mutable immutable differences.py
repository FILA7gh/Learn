...
Вот основные отличия между изменяемыми и неизменяемыми типами данных:
    ...
    Неизменяемые типы данных:
        ...
        Не могут быть изменены после создания: Значение неизменяемого типа данных
        не может быть изменено после создания объекта. Если вы пытаетесь изменить значение
