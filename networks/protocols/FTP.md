...
Преимущества и недостатки FTP:
    ...
    Недостатки:
        ...
        Безопасность: 
            ...
            Стандартный FTP передает данные в открытом виде, включая имена пользователей и пароли, что делает его уязвимым для перехвата.
        
    
        Устаревшие технологии: 
    
            Существуют более современные и безопасные протоколы для передачи файлов, такие как SFTP (SSH File Transfer Protocol) и FTPS (FTP Secure).
